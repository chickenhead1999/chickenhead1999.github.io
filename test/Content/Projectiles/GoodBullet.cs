...
{
    public class GoodBullet : ModProjectile
    {
        ...
        public override void AI()
       {
        ...
        var dust = Dust.NewDustDirect(position, 1, 1, 87, 0, 0, 100, Color.White, 2f);
        dust.noGravity = true;
        
        if (Projectile.timeLeft % 60 == 0 && Projectile.timeLeft != 300) {
        Projectile.velocity = Projectile.velocity.RotatedBy(MathHelper.Pi/5*4);
        // dust.velocity = dust.velocity.RotatedBy(MathHelper.Pi/5*4);
