...
namespace test.Content.Items
{
    ...
    public override void SetDefaults() {
			...
			Item.DamageType = DamageClass.Summon; // Whether your item is part of the melee class.
			...
			Item.value = Item.buyPrice(platinum: 100); // The value of the weapon in copper coins.
			Item.rare = -13;
			Item.UseSound = SoundID.Item1; // The sound when the weapon is being used.
			Item.shoot = ModContent.ProjectileType<Projectiles.先驱怒火>(); // 物品使用时发射的弹幕类型，这里是泰拉刃的剑气
			// Item.shootSpeed = 10f;
			// Item.pick = 1000;
			// Item.axe = 200;
			// Item.hammer = 1000;
