...
namespace test.Content.Items
{
    ...
    public override void SetDefaults() {
            ...
            Item.noUseGraphic = true;//是否在使用时显示贴图，默认显示，吸血飞刀这种不显示
			Item.value = Item.buyPrice(platinum: 1); // The value of the weapon in copper coins.
			Item.rare = -13;
			Item.UseSound = SoundID.Item1; // The sound when the weapon is being used.
			Item.shoot = ModContent.ProjectileType<Projectiles.MoodBullet>(); // 物品使用时发射的弹幕类型，这里是泰拉刃的剑气
			Item.shootSpeed = 10f;
		}
