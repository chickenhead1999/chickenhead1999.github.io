...
namespace test.Content.Items
{
    ...
    public override void SetDefaults() {
			...
			Item.useAnimation = 2; // The time span of the using animation of the weapon, suggest setting it the same as useTime.
			...
			Item.damage = 5000; // The damage your item deals.
		...
		public override bool Shoot(Player player, EntitySource_ItemUse_WithAmmo source, Vector2 position, Vector2 velocity, int type, int damage, float knockback)
		{
		    ...
		    Vector2 v = new Vector2(velocity.X, velocity.Y).RotatedByRandom(MathHelper.ToRadians(25f));
		    Projectile.NewProjectile(source, position, v, ProjectileID.TerraBeam, damage, knockback, player.whoAmI);
